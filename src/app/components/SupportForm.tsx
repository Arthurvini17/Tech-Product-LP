...
import { SupportFormProps } from "./SupportFormProps";
  ...
  return (
    ...
    >
      ...
      <div className="bg-slate-50 shadow-2xl p-10">
        ...
        <button className="bg-gradient-to-r  from-purple-500 to-purple-700  text-white p-2 rounded-2xl font-semibold text-2xl ">Send Message</button>
